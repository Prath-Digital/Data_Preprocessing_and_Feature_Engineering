<table>
    <tr>
        <td align="center">
            <img src=".assets/DP.png" alt="Logo" width="200"/>
        </td>
        <td align="center">
            <img src=".assets/FE.png" alt="Logo" width="200"/>
        </td>
    </tr>
</table>
...
![Static Badge](https://img.shields.io/badge/is%20fun-black?style=plastic&logo=proteus&label=Data%20Preprocessing)
![Static Badge](https://img.shields.io/badge/is%20fun-black?style=plastic&logo=createreactapp&logoColor=%23ffffff&label=Feature%20Engineering)
  ...
  <tbody>
    ...
    <tr style="background:#fff; color:#000;">
      ...
      <td style="padding:10px 8px;border:2px solid #000;">
        ...
        <span style="color:#fff;background:#2e7d32;padding:2px 6px;border-radius:4px;"><a style="color:#fff;text-decoration:none;" href="./Work/Lab Work/ch_1/lec_1.1/">🖥️ Work 🔗</a></span>
      </td>
    </tr>